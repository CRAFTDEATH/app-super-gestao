    ...
    <form action="{{ route('produto.update', $produto) }}" method="post">
        ...
        @else
            <form action="{{ route('produto.store') }}" method="post">
                ...
                <div style="padding:7px;">
                    <select type="text" name="fornecedor_id" id="fornecedor_id"
                            placeholder="Selecione fornecedo do produto aqui"
                            class="borda-preta">
                ...
                <div style="padding:7px;">
                    <select type="text" name="unidade_id" id="unidade_id"
                            placeholder="Selecione unidade do produto aqui"
                            class="borda-preta">
